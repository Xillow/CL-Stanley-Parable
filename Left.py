...
def Left():
	...
	print("In the meeting room: \n)
        ...
        print("[Player steps out into the hallway]\n")
		decision = input("what is your choice?(\"enter\" or \"close\")
		                                         elif input == CHOICE_1:
        print("Ah, second player! It's good to have you on board. I guarantee you can't do any worse than the person who came before you.\n")
		decision = input("what is your choice?(\"enter\" or \"close\")
		                                             elif input == CHOICE_1:
        print("[Player steps back into the broom closet]\n")
		decision = input("what is your choice?(\"enter\" or \"close\")
		                                                 elif input == CHOICE_1:
        print("You too? Unbelievable. I'm at the mercy of an entire species, of invalids. Perhaps there's a monkey nearby you can hand the controls too. A fish, fungus. Look, you can hammer out the details, I'm not particularly picky. I'll just be waiting for when you're ready to pick up the story again.\n")
		decision = input("what is your choice?(\"enter\" or \"close\")
		                                                     elif input == CHOICE_1:
        print("[Later on in the game, when the Player goes back into the broom closet]\n")
		decision = input("what is your choice?(\"enter\" or \"close\")
		                                                         elif input == CHOICE_1:
        print("Oh, no! Oh, no no no no no no no no no no no no, not again- I won't be part of this- I'm not going to encourage you- I'm not going to say anything at all. I'm just going to be patient and wait for you to finish whatever it is you enjoy doing so much in this room. Please, take your time.\n")
		decision = input("what is your choice?(\"enter\" or \"close\")
		                                                             else input == CHOICE_1:
        print("Getting to the staircase:\n")
        print("Coming to a staircase, Stanley walked upstairs to his boss's office.\n")
		decision = input("You have to continue?(\"close\")
